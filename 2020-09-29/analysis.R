...
download.file("https://opendata.arcgis.com/datasets/5d6bf4760af64db48b6d053e7569a47b_3.csv", "5d6bf4760af64db48b6d053e7569a47b_3.csv")
cumulative_byplace <- fread("5d6bf4760af64db48b6d053e7569a47b_3.csv", na.strings=c(""))
